...
export default function PainelFaixaInferior({
    ...
    return (
        <div className="absolute bottom-0 left-0 right-0 z-20 grid h-[var(--altura-faixa)] grid-cols-[clamp(130px,15vw,210px)_minmax(0,1fr)_clamp(130px,16vw,240px)] items-center overflow-hidden bg-gradient-to-r from-[#063ea8] via-[#0d5cff] to-[#063ea8] px-0 text-white shadow-[0_-18px_60px_rgba(0,0,0,0.28)]">
