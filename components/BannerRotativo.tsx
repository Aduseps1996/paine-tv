            ...
            <div className="absolute inset-0">
                ...
                {midiaAtual.tipo === "imagem" ? (
                    <img
                        ...
                        className={`absolute top-0 left-0 w-full h-[calc(100vh-6.5rem)] object-cover scale-[1.02] animate-[zoomBanner_22s_linear_infinite] brightness-[0.96] contrast-[1.04] saturate-[1.02] ${possuiRotacao
                    ...
                    <video
                        ...
                        muted
                        playsInline
                        className={`absolute top-0 left-0 w-full h-[calc(100vh-6.5rem)] object-cover brightness-[0.96] contrast-[1.04] saturate-[1.02] ${possuiRotacao
                            ? `transition-opacity duration-700 ease-in-out ${visivel ? "opacity-100" : "opacity-0"
                            }`
                            : ""
                            }`}
            ...
            <div className="absolute inset-0 overflow-hidden">
                {midiaAtual.tipo === "imagem" ? (
                    <img
                        ...
                        className={`absolute top-0 left-0 right-0 bottom-[108px] object-cover scale-[1.02] animate-[zoomBanner_24s_linear_infinite] brightness-[0.92] contrast-[1.04] ${possuiRotacao
                            ? `transition-opacity duration-700 ease-in-out ${visivel ? "opacity-100" : "opacity-0"
                            }`
                            : ""
                            }`}
                    ...
                    <video
                        ...
                        muted
                        playsInline
                        className={`absolute top-0 left-0 right-0 bottom-[108px] object-cover brightness-[0.92] contrast-[1.04] ${possuiRotacao
                            ? `transition-opacity duration-700 ease-in-out ${visivel ? "opacity-100" : "opacity-0"
                            }`
                            : ""
                            }`}
                ...
                <div className="absolute left-14 top-1/2 -translate-y-1/2 w-[560px]">
                    <div className="rounded-[2rem] border border-white/10 bg-black/20 bg-black/35 p-10 shadow-[0_25px_80px_rgba(0,0,0,0.45)]">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                {midiaAtual.tipo === "imagem" ? (
                    <img
                        ...
                        className={`absolute top-0 left-0 right-0 bottom-[108px] object-cover brightness-[0.45] ${possuiRotacao
                            ? `transition-opacity duration-700 ease-in-out ${visivel ? "opacity-100" : "opacity-0"
                            }`
                            : ""
                            }`}
...

            {
                midiaAtual.tipo === "imagem" ? (
                    ...
                    <img
                        ...
                        className={`absolute top-0 left-0 right-0 bottom-[108px] object-cover ${possuiRotacao
                            ? `transition-opacity duration-700 ease-in-out ${visivel ? "opacity-100" : "opacity-0"
                            }`
                            : ""
                            }`}
                    ...
                    <video
                        ...
                        autoPlay
                        muted
                        className={`absolute top-0 left-0 right-0 bottom-[108px] object-cover brightness-[0.96] contrast-[1.04] saturate-[1.02] ${possuiRotacao
                            ? `transition-opacity duration-700 ease-in-out ${visivel ? "opacity-100" : "opacity-0"
                            }`
                            : ""
                            }`}
